CREATE TABLE Production.UpdatedInventory (ProductID INT NOT NULL,
                                          LocationID INT,
                                          NewQty INT,
                                          PreviousQty INT,
...
SELECT ProductID,
       ...
       NewQty,
       PreviousQty
  FROM (   MERGE Production.ProductInventory AS pi
           ...
           OUTPUT $action,
                  ...
                  Deleted.Quantity AS PreviousQty) AS Changes(Action, ProductID, LocationID, NewQty, PreviousQty)
 WHERE Action = 'UPDATE';
GO
